...
from .views import CreateTodoView,UpdateTodoView,DeleteTdoView,GetTodoView

urlpatterns = [
    path('create/', CreateTodoView.as_view() , name='create_Todo'),
    path('update/<str:pk>', UpdateTodoView.as_view() , name='update_Todo'),
    path('delete/<str:pk>', DeleteTdoView.as_view() , name='delete_Todo'),
    path('get/', GetTodoView.as_view() , name='get_Todo'),
